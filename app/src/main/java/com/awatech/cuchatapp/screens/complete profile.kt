...
fun CompleteProfileScreen(email: String,
    ...
    Column(modifier = Modifier
        ...
        Row (
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.completeprofilepage), contentDescription = "excited student",/* modifier = Modifier.aspectRatio(1f)*/)
                Text("You are one \n Step away from \n Completing  Your Profile \uD83E\uDD73", fontSize = MaterialTheme.typography.headlineMedium.fontSize)
            }
        }
        ...
        Button(onClick = {
            if(name.isEmpty()||matNo.isEmpty() || course.isEmpty()||yearOfGraduation.isEmpty()||level.isEmpty()){
            ...
            }else if (userViewModel.verifyAge(matNo, yearOfGraduation)){
                ...
                userViewModel.registerUser(name, email, password, matNo, course, yearOfGraduation, level)
            }
        },
